        ...
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-amber-100 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            ...
            >
                <div
                    ...
                    className="aspect-577/310 w-[36.0625rem] bg-linear-to-r from-[#600079] to-[#82009c] opacity-30"
                />
            </div>
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p className="text-sm text-purple-950">
                    The RTU-IFLDE FlexiLearnPro program is now under development. Wait for updates posted on our Facebook page.
                </p>
            </div>
